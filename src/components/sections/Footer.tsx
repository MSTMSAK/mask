        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-8 h-8 rounded-lg bg-[#131821] border border-[#1E293B] flex items-center justify-center text-[#94A3B8] hover:text-[#06B6D4] hover:border-[#06B6D4]/30 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['AI每日研判', '智能选股', '五维分析', '策略中心', '深度研报'].map((item) => (
                <li key={item}>
                  <a href="#" className="text-sm text-[#94A3B8] hover:text-[#06B6D4] transition-colors">
                    {item}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-10 pt-6 border-t border-[#1E293B]">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-[#64748B]">
              &copy; 2026 智投AI. All rights reserved.
            </p>
            <p className="text-xs text-[#64748B] text-center sm:text-right">
              本页面所有分析结果由AI模型生成，仅供参考，不构成任何投资建议。投资有风险，入市需谨慎。
            </p>
          </div>
        </div>
      </div>
